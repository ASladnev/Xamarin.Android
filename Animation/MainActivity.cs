...
namespace Animation
{
  ...
  public class MainActivity : ListActivity
  {
    ...
    protected override void OnCreate (Bundle bundle)
    {
      ...
      ListAdapter = new ArrayAdapter<SampleActivity> (this, Android.Resource.Layout.SimpleListItem1, Android.Resource.Id.Text1, _activities);
    }
  ...
  public class SampleActivity
  {
    ...
    {
      var intent = new Intent (context, ActivityToLaunch);
